   ...
   <div class="container-xxl flex-grow-1 container-p-y">
      <div class="d-flex justify-content-between align-items-center mb-4">
         <h4 class="fw-bold mb-0">
            <span class="text-muted fw-light">Informasi /</span> Tambah Baru
         </h4>
      ...
      <div class="card">
         <div class="card-body">
            <form action="{{ route('informasi.store') }}" method="POST" enctype="multipart/form-data" id="formInformasi">
               @csrf
               <div class="row">
                  <div class="col-md-8">
                     <div class="form-floating form-floating-outline mb-4">
                        <input type="text" class="form-control @error('judul') is-invalid @enderror" id="judul"
                           name="judul" value="{{ old('judul') }}" placeholder="Masukkan judul informasi" required>
                        ...
                        <div class="card-body">
                           ...
                           <div class="mb-3 text-center">
                              <div class="preview-container mb-3">
                                 <img src="{{ asset('assets/img/elements/18.png') }}" alt="Preview"
                                    class="img-fluid rounded shadow-sm" id="preview-img"
                           ...
                           <button type="submit" class="btn btn-primary w-100">
                              <i class="ri-save-line me-1"></i> Simpan Informasi
                           </button>
                        </div>
                     </div>
                  </div>
