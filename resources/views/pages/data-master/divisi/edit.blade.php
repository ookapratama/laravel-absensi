   ...
   <div class="container-xxl flex-grow-1 container-p-y">
      <div class="mb-4">
         <h4 class="fw-bold mb-0">
            <span class="text-muted fw-light">Data Master / Divisi /</span> Edit
         </h4>
      </div>
         ...
         <div class="col-md-8 mx-auto">
            <div class="card">
               <div class="card-header d-flex justify-content-between align-items-center">
                  <h5 class="mb-0">Edit Divisi: {{ $data->nama }}</h5>
               ...
               <div class="card-body">
                  <form action="{{ route('divisi.update', $data->id) }}" method="POST">
                     ...
                     <div class="row">
                        <div class="col-md-6 mb-3">
                           ...
                           <input type="text" class="form-control @error('kode') is-invalid @enderror" id="kode"
                              name="kode" value="{{ old('kode', $data->kode) }}" placeholder="IT">
                           @error('kode')
                     ...
                     <div class="row">
                        <div class="col-md-4 mb-3">
                           ...
                           <input type="time" class="form-control @error('jam_masuk') is-invalid @enderror"
                              ...
                              value="{{ old('jam_masuk', $data->jam_masuk ? $data->jam_masuk->format('H:i') : '') }}"
                              required>
                           @error('jam_masuk')
                              <div class="invalid-feedback">{{ $message }}</div>
                           @enderror
                        ...
                        <div class="col-md-4 mb-3">
                           ...
                           <input type="time" class="form-control @error('jam_pulang') is-invalid @enderror"
                              ...
                              value="{{ old('jam_pulang', $data->jam_pulang ? $data->jam_pulang->format('H:i') : '') }}"
                              required>
                           @error('jam_pulang')
                              <div class="invalid-feedback">{{ $message }}</div>
                           @enderror
                        ...
                        <div class="col-md-4 mb-3">
                           ...
                           <input type="number" class="form-control @error('toleransi_terlambat') is-invalid @enderror"
                              ...
                              value="{{ old('toleransi_terlambat', $data->toleransi_terlambat) }}" min="0"
                              max="120">
                     ...
                     <div class="mt-4">
                        ...
                        <a href="{{ route('divisi.index') }}" class="btn btn-label-secondary">Batal</a>
                     </div>
                  </form>
               </div>
            </div>
